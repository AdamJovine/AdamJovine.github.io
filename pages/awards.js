        ...
        <div className="content-container">
          ...
          <div className="awards-content" style={{ color: '#374151' }}>
            ...
            <div className="award-item">
              <span className="award-bullet"></span>
              <div className="award-content">
                <div className="award-title">Mogensen Excellence Award</div>
                <div className="award-description">Award given to the best Operations Research student at Cornell. </div>
              </div>
            </div>
            <div className="award-item">
              <span className="award-bullet"></span>
              <div className="award-content">
                <div className="award-title">Omega Rho Scholar</div>
                <div className="award-description"> honors society for top 10% of Operations Research seniors at Cornell </div>
              </div>
            </div>
